...
This document is the source of truth for cross-app standards. It lives in the
[localapps](https://github.com/j23n/localapps) umbrella repo. Each app repo has
a short `.claude/CONVENTIONS.md` stub that points here (see [§18](#18-canonical-location)).
...
| Swift 6 strict concurrency | ✅ Swift 6, `complete` | ✅ Swift 6, `complete` | ✅ Swift 6, `complete` |
| `@Observable` state | ✅ | ✅ | ✅ |
...
| Swift Testing | ✅ | ✅ | ✅ |
| Tests in CI | ✅ (separate test.yml) | ✅ (separate test.yml) | ✅ (separate test.yml) |
| `macos-26` runner | ✅ | ✅ | ✅ |
...
.claude/
  ...
  CONVENTIONS.md         # redirect to localapps/.claude/CONVENTIONS.md (see §18)
.github/workflows/
...
and CryptoKit makes them equally easy.
...
This file lives at `.claude/CONVENTIONS.md` in the
[localapps](https://github.com/j23n/localapps) repo — the umbrella repo for
the localfiles family, which also hosts the project website.

Each app repo has a short `.claude/CONVENTIONS.md` stub that redirects here.
To edit: open this file in localapps, make the change, and update the stub
date in the three app repos so it's clear the redirect is current.

[canon]: https://github.com/j23n/localapps/blob/main/.claude/CONVENTIONS.md
