...
| [0004](adr/0004-ui-spec-and-shells.md) | UI specification, slot vocabulary, shells — kinds in [`ui/vocabulary.toml`](ui/vocabulary.toml); contacts screens in [`apps/contacts/ui-spec/`](../../apps/contacts/ui-spec/); tokens (light-only) in [`design/tokens/`](../../design/tokens/) |
