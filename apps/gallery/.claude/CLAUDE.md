...
- **Phase 1 / Phase 2:** no File Provider surface. The scanner is local-only (`ScannerSession()`); placeholders do not enter the projection. Do not restore per-file provider keys.
